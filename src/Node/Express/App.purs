...
data AppM e a = AppM (Application -> ExpressM e a)
...
--| HTTP version
listenHttp :: forall e. App e -> Port -> (Event -> Eff e Unit) -> ExpressM e Unit
...
--| Run application on specified port and execute callback after launch.
--| HTTPS version
listenHttps :: forall e opts. App e -> Port -> opts -> (Event -> Eff e Unit) -> ExpressM e Unit
...
getProp :: forall e a. (IsForeign a) => String -> AppM e (Maybe a)
