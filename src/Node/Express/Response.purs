...
import Node.Express.Types (CookieOptions(..), Response, SameSite(..))
...
setCookie name val (CookieOptions opts) = HandlerM \_ resp _ ->
  liftEffect $ runFn4 _setCookie resp name val $ modify (Proxy :: Proxy "sameSite") fromSameSite opts
  where
...
foreign import _setCookie
  :: Fn4 Response String String
       { maxAge :: Int
       , signed :: Boolean
       , path :: String
       , sameSite :: String
